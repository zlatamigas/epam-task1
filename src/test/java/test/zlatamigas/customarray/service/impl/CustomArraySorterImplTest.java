...
public class CustomArraySorterImplTest {
    ...
    public Object[][] createData() {
        return new Object[][]{
                { new int[]{23, -1, 43, 900, -7, 55, 12, 0}, new CustomArray(-7, -1, 0, 12, 23, 43, 55, 900)},
                { new int[]{900, 55, 43, 23, 12, 0, -1, -7}, new CustomArray(-7, -1, 0, 12, 23, 43, 55, 900)},
                { new int[]{-7}, new CustomArray(-7)},
                { new int[]{-7, -1, 0, 23, 12, 43, 55, 900}, new CustomArray(-7, -1, 0, 12, 23, 43, 55, 900)},
                { new int[]{}, new CustomArray()}
        };
    }
    ...
    public void testBubbleSort(int[] arrayUnsorted, CustomArray expected) {
        CustomArray actual = new CustomArray(arrayUnsorted.clone());
